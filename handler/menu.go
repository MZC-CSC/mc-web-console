...
func GetAllMCIAMAvailableMenus(c echo.Context) (*Menus, error) {
	commonResponse, err := common.AnyCaller(c, "getallavailablemenus", &common.CommonRequest{
...
func CreateMCIAMMenusByLocalMenuYaml(c echo.Context) error {
	...
	req.Header.Add("Authorization", c.Get("Authorization").(string))
