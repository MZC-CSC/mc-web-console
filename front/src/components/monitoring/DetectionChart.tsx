...
/**
 * Detection Graph 차트 컴포넌트
 * TODO: 차트 라이브러리 연동 필요 (Recharts 등)
 */
export function DetectionChart({ data, isLoading = false }: DetectionChartProps) {
  if (isLoading) {
    return (
      <Card className="p-6">
  ...
  return (
    <Card className="p-6">
      <h4 className="text-md font-semibold mb-4">Detection Graph</h4>
